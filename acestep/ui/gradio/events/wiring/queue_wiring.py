...
def register_queue_handlers(
    ...
    # Add to Queue click (single task)
    queue_inputs = [
    ...
    if "add_multiple_to_queue_btn" in generation_section and "queue_count" in generation_section:
        generation_section["add_multiple_to_queue_btn"].click(
            fn=q_handlers.add_to_queue_handler,
